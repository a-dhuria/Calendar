    ...
    return (
        <div className="singleUpdate">
            ...
            <form action="" className="main-form" onSubmit={handleSubmit}>
                ...
                <label for="Practice" className="updateEvents-label">Practice​</label>
                <select id="Practice" name="Practice" value={selectedPractice} onChange={handlePracticeChange} required className="updateEvents-select">
                    {renderRandomOptions([...new Set(dropDownData.map(result => result.practice))])}
                    <option value="other">Other</option>
                </select>
                ...
                <input type="url" id="duration" name="duration" placeholder="Enter the Link" required className="updateEvents-input" value={registration} onChange={handleRegistration}/>
                <div className="wrap">
